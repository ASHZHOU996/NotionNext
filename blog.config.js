...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '一匹马赛克', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '每一篇都很用心', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.youtube.com/@mosaicnexus', // 网站地址
